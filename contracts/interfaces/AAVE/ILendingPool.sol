...
interface ILendingPool3 {
   ...
   **/
  function setConfiguration(address asset, DataTypes3.ReserveConfigurationMap calldata configuration)
    external;
  ...
  function getConfiguration(address asset)
    external
    view
    returns (DataTypes3.ReserveConfigurationMap memory);
  ...
  function getUserConfiguration(address user)
    external
    view
    returns (DataTypes3.UserConfigurationMap memory);
